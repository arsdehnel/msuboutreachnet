...
<%
	...
	objComm("@p_in_process_type") 			= "STSCD"
	objComm("@p_in_mailing_list_detail_id") = validate_field(Request.QueryString("mailing_list_detail_id"),"pl")
	objComm("@p_in_mailing_list_master_id") = Null

...
<%
	...
	int_mailing_list_master_id			= fnc_qs_value_lookup( objComm("@p_variable_string"), "mailing_list_master_id" )
	
	Response.Redirect("/mailing_lists/maintenance/index.asp?which=" & int_mailing_list_master_id)

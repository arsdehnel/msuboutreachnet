...
<div class="event_form_detail"><strong>Credits:</strong> <?=$event_master_obj->primary_credit;?></div>
<div class="event_form_detail"><strong>Evaluation of Student Work:</strong> <?=$event_master_obj->eval_of_work;?></div>
<div class="event_form_detail"><strong>Grading:</strong> <?=$event_master_obj->grading_desc;?></div>
<div class="event_form_detail"><strong>Required Materials:</strong> <?=$event_master_obj->req_mtrls;?></div>
<div class="event_form_detail"><strong>Post-Course Work Requirements & Due Dates:</strong> <?=$event_master_obj->pst_crse_wk;?></div>
...
?>
<div class="event_form_detail"><strong>Comments:</strong> <?=$event_master_obj->caf_cmts;?></div>
